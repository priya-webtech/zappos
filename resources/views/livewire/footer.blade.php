            ...
            <div class="row ">
                ...
                <div class="col-md-3 col-6">
                    <div class="col-12 p-0 footer-inner-col">
                        <h4 class="h4">Customer Service</h3>
                        <ul class="list-unstyled">
                            <li><a href="#">FAQs</a></li>
                ...
                <div class="col-md-4 col-6 footer-last-col">
                    <div class="col-12 p-0 footer-inner-col newsletter-col">
                        <h4 class="h4">Newsletter</h3>
                    ...
                    <div class="col-12 p-0 footer-inner-col footer-social-col">
                        <h4 class="h4">Connect With Us</h3>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p>&copy; 2020-2021 - Bytewise LLC or its affiliates</p>
                    </div>
                </div>
            </div>
        </div>
