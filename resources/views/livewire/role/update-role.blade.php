                ...
                <article class="full-width">
                    <div class="columns customers-details-heading">
                        <div class="page_header d-flex  align-item-center">
                            ...
                            <h4 class="mb-0 fw-5">Update Role</h4>
                        </div>
                    </div>
                </article>
            </section>
            ...
            <section class="full-width flex-wrap admin-body-width" wire:ignore>
                ...
                <article class="full-width">
                    ...
                    <div class="columns ten">
                        ...
                        <div class="card">
                            ...
                            <article class="full-width">
                                ...
                                <div class="columns row">
                                    ...
                                    <input id="role_name" wire:model="role.name" class="block mt-1 w-full" type="text" name="role_name" autofocus />
                        ...
                        <a wire:click.prevent="roleUpdate({{$role->id}})" class="button green-btn float-right" wire:ignore>save</a>
