<div>
	...
	<div class="loading-overlay" wire:loading.flex wire:target="resetInputFields,update,EditAddress">
               ...
               <div class="columns one-third right-details">
                  ...
                  <div class="card pd-20 tag-card card-grey-bg">
                     <div class="header-title">
                        ...
                        <button class="link"  data-toggle="modal" data-target="#view-all-tags">View all tags</button>
                     </div>
                        ...
                        <div class="row">
                           ...
                           <div class="form-field-list">
                              ...
                              <div class="cd-phone-field">
                                 ...
                                 <input class="rounded-md shadow-sm block mt-1 w-full"  id="customer_mobile_number" type="text" name="customer_mobile_number" autofocus="autofocus" autocomplete="customer.mobile_number" name="mobile_number" wire:model.lazy="customerData.mobile_number">
            ...
            <div class="customer-modal-inner">
               <div class="customer-modal">
                  ...
                  <div class="modal-footer">
                     ...
                     <div class="button-col">
                        <button class="button secondary" wire:click="resetInputFields()">Cancel</button>
                        <button class="button" data-dismiss="modal" data-toggle="modal" data-target="#manage-address-modal" wire:click.prevent="update('Address-change')">Save</button>
                     </div>
                  </div>
               </div>
            </div>
